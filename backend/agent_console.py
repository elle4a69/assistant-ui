...
def build_agent_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "task may use its audited automatic release path; protected runtime changes still require the current owner "
        "message to exactly match the one-time confirmation phrase enforced by the tool.\n"
        ...
        "inspection, review, or safe retry. After reviewing a completed coding task, queue its audited automatic release "
        "rather than waiting for another owner message.\n\n"
